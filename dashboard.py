...
# -15.79812282802249, -47.91390237350846
app = dash.Dash(__name__, external_stylesheets=[dbc.themes.CYBORG])

fig = px.choropleth_mapbox(df_states_, locations="estado", color="casosNovos", center={"lat": -15.79, "lon": -47.91}, zoom=4, geojson=brazil_states, color_continuous_scale="YlGn", 
                            opacity=0.4, hover_data={"casosAcumulado":True, "casosNovos":True, "estado":True})
...
app.layout = dbc.Container(
    dbc.Row([
        dbc.Col([
            html.Div([
                html.Img(id="logo", src=app.get_asset_url("logo.png"), height=70),
                html.H5("Evolução COVID-19 | J.P BARAÚNA"),
                dbc.Button("BRASIL", color="warning", id="location-button", size="lg")
            ], style={}),
            html.P("Informe a data do período que deseja obter informações: ", style={"margin-top": "40px"}),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.H3(style={"color":"#F9D949"}, id="casos-confirmados-text"),
                            html.Span("Novos casos no período"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            html.H3(style={"color":"#F45050"}, id="obitos-text"),
            ...
            html.Div([
                html.P("Selecione o tipo de dado de sua preferência: ", style={"margin-top": "25px"}),
...
def update_map(date):
    ...
    fig = px.choropleth_mapbox(df_data_on_states, locations="estado", geojson=brazil_states, 
        ...
        zoom=4, color="casosAcumulado", color_continuous_scale="YlGn", opacity=0.55,
